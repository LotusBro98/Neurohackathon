...
dataset = pickle.load(open("Robotrack/datasets/data.pickle", "rb"))
dataset2 = pickle.load(open("Robotrack/datasets/data2.pickle", "rb"))

features = dataset['features']
labels = dataset['labels']
Nhistory = dataset['Nhistory']

features2 = dataset2['features']
...
if (os.path.isfile("Robotrack/net/checkpoint")):
